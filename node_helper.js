  ...
  socketNotificationReceived: function (notification, payload) {
    ...
    switch (notification) {
      ...
      case "GEMINI_TEXT_RESPONSE":
        // Always update status to indicate processing/receiving response
        // this.currentStatusText = "Processing..." // Or keep "Listening..."? User preference. Let's keep Listening for now.
      ...
      case "GEMINI_TURN_COMPLETE":
        ...
        // Maybe clear response after a timeout? For now, keep it until next interaction.
        break
      case "HELPER_ERROR":
        this.currentState = "ERROR"
